...
<html>
  ...
  <body>
	  ...
	  <header>
		...
		<ul class ="Menu">
			<li><a href ="index1.php">Acueille </a></li>
			<li><a href ="formTicket.php" class= "active" >  Ticket </a></li>
			<li><a href ="recupTicket.php" class ="">Evénements </a></li>
			<li><a href ="contact.php" class ="">Contacts</a></li>
			<li><a href ="logout.php" class ="">Log out</a></li>
			<li><a href ="authentificati1.php" class ="btn btn "> Sign in </a></li>
			<?php 
