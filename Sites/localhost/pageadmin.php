...
<html>
  ...
  <body>
   ...
   <ul class ="nav-menu">
		...
		<li><a href ="formTicket.php" class= "nav-links">  Ticket </a></li>
		<li><a href ="recupTicket.php" class ="nav-links">Profile </a></li>
		<li><a href ="recupUser.php" class ="nav-links">Users</a>
			<ul>
		<li><a href ="affichecon.php" class ="nav-links">Reclaim</a></li>
			</ul>
		</li>
